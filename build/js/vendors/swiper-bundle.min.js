    ...
    V = {
      ...
      eventsEmitter: {
        ...
        onAny: function (e, t) {
          ...
          return (
            this.eventsAnyListeners.indexOf(e) < 0 && this.eventsAnyListeners[i](e), this
          );
        },
        offAny: function (e) {
            ...
            for (
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  ...
                  (I =
                    (O = G - (A = Math.floor(G / B)) * B + D * t.slidesPerGroup) +
                    (A * T) / z),
                    L.css({
        ...
        if (
          ...
          if (!(r < i.slideWidth && n < i.slideHeight)) {
            ...
            e.cancelable && e.preventDefault(),
              ...
              (a.x =
                (s.touchesCurrent.x - a.prevPositionX) / (Date.now() - a.prevTime) / 2),
              (a.y =
                (s.touchesCurrent.y - a.prevPositionY) / (Date.now() - a.prevTime) / 2),
      ...
      onThumbClick: function () {
        ...
        if (e) {
          var t = e.clickedIndex,
            i = e.clickedSlide;
          if (
            !((i && m(i).hasClass(this.params.thumbs.slideThumbActiveClass)) || null == t)
          ) {
            var s;
            if (
              ((s = e.params.loop
